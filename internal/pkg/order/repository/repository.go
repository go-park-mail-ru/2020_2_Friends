...
func (o OrderRepository) AddOrder(userID string, order models.OrderRequest) (int, error) {
	...
	err := o.db.QueryRow(
		"INSERT INTO orders (userID, vendorName, products, createdAt, clientAddress) VALUES($1, $2, $3, $4, $5) RETURNING id",
		userID, order.VendorName, pq.Array(order.Products), order.CreatedAt, order.Address,
	).Scan(&orderID)
