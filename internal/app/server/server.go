...
func StartApiServer() {
	...
	mux.Handle("/api/v1/profiles", authChecker.Check(profDelivery.Get)).Methods("GET")
	mux.Handle("/api/v1/profiles", authChecker.Check(profDelivery.Update)).Methods("PUT")
	mux.Handle("/api/v1/profiles/avatars", authChecker.Check(profDelivery.UpdateAvatar)).Methods("PUT")
	mux.Handle("/api/v1/profiles/addresses", authChecker.Check(profDelivery.UpdateAddresses)).Methods("PUT")
	...
	mux.Handle("/api/v1/vendors", authChecker.Check(accessRighsChecker.AccessRightsCheck(partnerDelivery.CreateVendor, configs.AdminRole))).Methods("POST")
	mux.Handle("/api/v1/vendors/{id}", authChecker.Check(accessRighsChecker.AccessRightsCheck(partnerDelivery.UpdateVendor, configs.AdminRole))).Methods("PUT")
	mux.Handle("/api/v1/vendors/{id}/pictures", authChecker.Check(accessRighsChecker.AccessRightsCheck(partnerDelivery.UpdateVendorPicture, configs.AdminRole))).Methods("PUT")
	mux.Handle("/api/v1/vendors/{id}/products", authChecker.Check(accessRighsChecker.AccessRightsCheck(partnerDelivery.AddProductToVendor, configs.AdminRole))).Methods("POST")
	mux.Handle("/api/v1/vendors/{vendorID}/products/{id}", authChecker.Check(accessRighsChecker.AccessRightsCheck(partnerDelivery.UpdateProductOnVendor, configs.AdminRole))).Methods("PUT")
	mux.Handle("/api/v1/vendors/{vendorID}/products/{id}", authChecker.Check(accessRighsChecker.AccessRightsCheck(partnerDelivery.DeleteProductFromVendor, configs.AdminRole))).Methods("DELETE")
	mux.Handle("/api/v1/vendors/{vendorID}/products/{id}/pictures", authChecker.Check(accessRighsChecker.AccessRightsCheck(partnerDelivery.UpdateProductPicture, configs.AdminRole))).Methods("PUT")
	...
	mux.Handle("/api/v1/carts", authChecker.Check(cartDelivery.AddToCart)).Methods("PUT")
	mux.Handle("/api/v1/carts", authChecker.Check(cartDelivery.RemoveFromCart)).Methods("DELETE")
	mux.Handle("/api/v1/carts", authChecker.Check(cartDelivery.GetCart)).Methods("GET")
	...
	mux.Handle("/api/v2/profiles", authChecker.Check(profDelivery.Get)).Methods("GET")
	mux.Handle("/api/v2/profiles", authChecker.Check(profDelivery.Update)).Methods("PUT")
	mux.Handle("/api/v2/profiles/avatars", authChecker.Check(profDelivery.UpdateAvatar)).Methods("PUT")
	mux.Handle("/api/v2/profiles/addresses", authChecker.Check(profDelivery.UpdateAddresses)).Methods("PUT")
	...
	mux.Handle("/api/v2/vendors", authChecker.Check(accessRighsChecker.AccessRightsCheck(partnerDelivery.CreateVendor, configs.AdminRole))).Methods("POST")
	mux.Handle("/api/v2/vendors/{id}", authChecker.Check(accessRighsChecker.AccessRightsCheck(partnerDelivery.UpdateVendor, configs.AdminRole))).Methods("PUT")
	mux.Handle("/api/v2/vendors/{id}/pictures", authChecker.Check(accessRighsChecker.AccessRightsCheck(partnerDelivery.UpdateVendorPicture, configs.AdminRole))).Methods("PUT")
	mux.Handle("/api/v2/vendors/{id}/products", authChecker.Check(accessRighsChecker.AccessRightsCheck(partnerDelivery.AddProductToVendor, configs.AdminRole))).Methods("POST")
	mux.Handle("/api/v2/vendors/{vendorID}/products/{id}", authChecker.Check(accessRighsChecker.AccessRightsCheck(partnerDelivery.UpdateProductOnVendor, configs.AdminRole))).Methods("PUT")
	mux.Handle("/api/v2/vendors/{vendorID}/products/{id}", authChecker.Check(accessRighsChecker.AccessRightsCheck(partnerDelivery.DeleteProductFromVendor, configs.AdminRole))).Methods("DELETE")
	mux.Handle("/api/v2/vendors/{vendorID}/products/{id}/pictures", authChecker.Check(accessRighsChecker.AccessRightsCheck(partnerDelivery.UpdateProductPicture, configs.AdminRole))).Methods("PUT")
	...
	mux.Handle("/api/v2/carts", authChecker.Check(cartDelivery.AddToCart)).Methods("PUT")
	mux.Handle("/api/v2/carts", authChecker.Check(cartDelivery.RemoveFromCart)).Methods("DELETE")
	mux.Handle("/api/v2/carts", authChecker.Check(cartDelivery.GetCart)).Methods("GET")
